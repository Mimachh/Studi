<?php  require 'layout/navbar.php'; ?>
    ...
    <main>
      ...
      <div class="container-fluid text-white-50">
        ...
        <ol id="menu">
          <li><a href="#frodon">Fraudons et Sam</a></li>
          <li><a href="#aragorn">Aragorn, Légolas, Gimli</a></li>
          <li><a href="#gandalf">Glandalf</a></li>
          <li><a href="">Bor-au-mir</a></li>
          <li><a href="">Mer-riz et Pépin</a></li>
      </ol>  
      </div>

        <!-- Team 1-->
        <div class="text-white-50 container-fluid mt-4 team1 rounded-3" id="frodon">
          ...
          <div class="row ">
              ...
              <div class="col-12 col-sm-12 col-md-5 p-4 ">
                  ...
                  <p>Attachants, faciles à vivre. Sam(à gauche) est très bon cuisinier, Fraudons (à droite) est un un opportuniste ayant passé sa vie en viager avec son oncle. <br>
        ...
        <!-- Team 2-->
          ...
          <div class="text-white-50 container-fluid" id="aragorn">
            ...
            <div class="row  inverse-order">
                <div class="col-12 col-sm-12 col-md-5 p-4">
                  ...
                  préférant vivre chez son beau-père Elrond.</li> 
                      <li>Legolas (au centre) parcours le monde depuis qu'il a été chassé de la forêt de son père. </li> 
          ...
          <!-- Team 3-->
          <div class="text-white-50 container-fluid" id="gandalf">
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-12 col-md-5 p-4">
                ...
                <p>Un sans adresse-fixe qui a roulé sa bosse, fumeur de pipe, spécialiste des feux d'artifice.<br> 
                  Compte se reconvertir en concepteur de pont lorsqu'il aura quitté la communauté. </p>
              </div>
            </div>
          </div>
          ...
          <div class="text-white-50 container-fluid">
